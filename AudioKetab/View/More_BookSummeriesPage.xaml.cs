...
var item = (Xamarin.Forms.Button)sender;
		...
		public More_BookSummeriesPage(MainPage context)
		{
			...
			var ret = WebService.GetMoreBookSummeries();
			if (ret == "success")
			{
				ProcessResult(true);
		...
		private void ProcessResult(bool flag)
		{
			...
			try
			{
				...
				listview_recentadded.ItemsSource = items.Items;
				...
				listview_mostplayed.ItemsSource = items1.Items;
				...
				listview_recentfollowers.ItemsSource = items2.Items;
